...
RUN requirements="libmcrypt-dev g++ libicu-dev libmcrypt4 libmcrypt-dev zlib1g-dev git libpng-dev libbz2-dev libpq-dev libxml2-dev curl libcurl4-openssl-dev libpng16-16 libpq5" \
